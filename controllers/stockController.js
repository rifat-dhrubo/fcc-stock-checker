...
const singleQueryController = async (req, res, next) => {
	// query destructuring
...
const multipleQueryController = async (req, res, next) => {
	// query destructuring
...
module.exports = { singleQueryController, multipleQueryController };
